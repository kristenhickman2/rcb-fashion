			...
			echo '<li>',
				...
				if ( ! empty( $slide['slide_link'] ) ) {
					...
					if ( empty( $slide['slide_button'] ) ) {
						$slide['slide_button'] = __( 'View More', 'shuttle' );
					}
	...
	if ( is_front_page() ) {
		...
		echo '<div id="section-home"><div id="section-home-inner">';
			...
			echo	'</div>',
					...
					if ( ! empty( $shuttle_homepage_section1_link ) ) {
						echo '<p class="iconurl"><a class="" href="' . esc_url( $shuttle_homepage_section1_link ) . '">' . __( 'View More', 'shuttle' ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
			...
			echo	'</div>',
					...
					if ( ! empty( $shuttle_homepage_section2_link ) ) {
						echo '<p class="iconurl"><a class="" href="' . esc_url( $shuttle_homepage_section2_link ) . '">' . __( 'View More', 'shuttle' ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
			...
			echo	'</div>',
				...
				if ( ! empty( $shuttle_homepage_section3_link ) ) {
					echo '<p class="iconurl"><a class="" href="' . esc_url( $shuttle_homepage_section3_link ) . '">' . __( 'View More', 'shuttle' ) . '</a></p>';
				}
			echo	'</div>',
					'</div>',
				'</article>';
			...
			if ( ! empty( $class_four_col4 ) ) {
				...
				echo	'</div>',
					...
					if ( ! empty( $shuttle_homepage_section4_link ) ) {
						echo '<p class="iconurl"><a class="" href="' . esc_url( $shuttle_homepage_section4_link ) . '">' . __( 'View More', 'shuttle' ) . '</a></p>';
					}
				echo	'</div>',
						'</div>',
					'</article>';
	...
	if ( $shuttle_homepage_introswitch == '1' and is_front_page() and ! empty( $shuttle_homepage_introaction ) ) {
		...
		echo '<div id="introaction"><div id="introaction-core">';
			...
			if ( ( !empty( $shuttle_homepage_introactionlink1) and $shuttle_homepage_introactionlink1 !== 'option3' ) ) {
				...
				// Set default value of buttons to "View More"
				if( empty( $shuttle_homepage_introactiontext1 ) ) { $shuttle_homepage_introactiontext1 = __( 'View More', 'shuttle' ); }
