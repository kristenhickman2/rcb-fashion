jQuery(document).ready(function($) {
    ...
    $( document ).on( 'click', '.widget_multi_add_field', cheery_widget_multi_add_field )
        .on( 'change', '.widget_multi_single_field', cheery_widget_multi_single_field )
        .on( 'click', '.widget_multi_remove_field', cheery_widget_multi_remove_field )

    function cheery_set_multi_add_field() {
    ...
    cheery_set_multi_add_field();
    
    function cheery_widget_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            cheery_widget_multi_write( $control );
    }

    function cheery_widget_multi_single_field() {
        var $control = $( this ).parents( '.widget_multi_input' );
        cheery_widget_multi_write( $control );
    }

    function cheery_widget_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.widget_multi_input' );
        $this.parent().remove();
    ...
    function cheery_widget_multi_write( $element) {
    ...
    $(document).on("click", ".cheery-accordion", function (e) {
        e.preventDefault();
        var $button = $(this);

        $button.next('.cheery-panel').slideToggle();
    ...
    function cheery_contentTypeChange() {
    ...
    cheery_contentTypeChange();

    function cheery_widget_chosen() {
        $(".cheery-widget-chosen-select").chosen({
            width: "100%"
        });
    }
    cheery_widget_chosen();
