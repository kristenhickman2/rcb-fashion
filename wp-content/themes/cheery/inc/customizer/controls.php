 ...
 */
Class Cheery_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Cheery_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Cheery_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="cheery-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @access public
 */
class Cheery_Customize_Section_Upsell extends WP_Customize_Section {
